...
//         let _ = move_to_notation(&mut board, &mut pawn,(4, 3)); // wait — pawn captures diagonally
...
//         let _ = move_to_notation(&mut board, &mut bishop, (1, 1)); // e6 -> b2 diagonal? check: (5,4)->(1,1) diff = (-4,-3) not diagonal
